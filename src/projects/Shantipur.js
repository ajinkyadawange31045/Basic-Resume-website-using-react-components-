      ...
      <div className="container-fluid p-0">
        ...
        <section className="resume-section" id="awards">
          ...
          <h4 className="mt-5">Checkout </h4>
              ...
              <a className="text-light btn btn-dark m-2 " href="http://ajinkya31045.pythonanywhere.com/" target="_blank" rel="noreferrer"><i class="fa-solid fa-arrow-up-right-from-square fa-bounce"></i></a>
