        ...
        <section className="resume-section" id="awards">
          ...
          <div className="flexard">
              ...
              <div className="card">
                ...
                <p className="card-title btn btn-light"><a href="project/study-space" className="card-link" target="_blank" rel="noreferrer">Know More</a></p>
              </div>
              <div className="card">
                <img src="assets/img/miniblog.png" alt="" />
                <p className="card-desc ">4. Blog using django (my first database project) (CRUD operation)</p>
                <p className="card-title btn btn-light"><a href="project/mini-blog" className="card-link" target="_blank" rel="noreferrer">Know More</a></p>
              </div>
              <div className="card">
